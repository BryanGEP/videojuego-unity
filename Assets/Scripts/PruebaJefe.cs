...
public class PruebaJefe : MonoBehaviour
{
    ...
    public AudioClip sonidoJefe;
    public float escalaJefe = 2f;
    ...
    void Start()
    {
        ...
        if (esJefe)
        {
            transform.localScale = new Vector3(escalaJefe, escalaJefe, 1);
        }
    }
    ...
    private void Movimiento()
    {
        ...
        {
            if (esJefe && !audioReproducido && sonidoJefe != null)
            {
                audioSource.PlayOneShot(sonidoJefe);
